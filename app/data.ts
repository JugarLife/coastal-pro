...
export const PENINSULA_VIEWBOX = '-56 -74 1112 904';

export const SUBURBS: { name: string; x: number; y: number }[] = [
  { name: 'Portsea', x: 86.6, y: 501.5 },
  { name: 'Sorrento', x: 163.7, y: 485.1 },
  { name: 'Blairgowrie', x: 259.9, y: 447.7 },
  { name: 'Rye', x: 365.1, y: 389.7 },
  { name: 'Rosebud', x: 482.2, y: 243.4 },
  { name: 'Dromana', x: 618.9, y: 92.7 },
  { name: 'Safety Beach', x: 667.3, y: 90.4 },
  { name: 'Mount Martha', x: 761.6, y: 22.8 },];
